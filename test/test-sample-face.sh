...
$CMD \
sample -i ${DATA}/plane.obj -m ${DATA}/plane.png -o ${TMP}/sample_face_plane_10_bilinear_2_2.ply --mode face --hideProgress --resolution 10 --bilinear END \
sample -i ${DATA}/plane.obj -m ${DATA}/plane.png -o ${TMP}/sample_face_plane_10_nearest_2_2.ply --mode face --hideProgress --resolution 10 END \
sample -i ${DATA}/plane.obj -m ${DATA}/plane_10_10.png -o ${TMP}/sample_face_plane_10_nearest_10_10.ply --mode face --hideProgress --resolution 10 \
> ${TMP}/${OUT}.txt 2>&1

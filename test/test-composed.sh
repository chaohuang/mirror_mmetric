...
sample -i ${EXTDATA}/basketball_player_00000001_qp8_orig.obj -m ${EXTDATA}/basketball_player_00000001.png -o ID:pc2 --mode map --hideProgress END \
...
fileHasString ${TMP}/${OUT}.txt "PCQM-PSNR=37.5391" 1
